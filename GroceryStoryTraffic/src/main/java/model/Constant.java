...
public class Constant {
    ...
    public Constant() {
        ...
        Map<String, double[]> sixToNine = new HashMap<>();
        sixToNine.put("Monday", new double[]{0.3, 0.55, 0.15, 0, 0, 0});
        sixToNine.put("Tuesday", new double[]{0.3, 0.55, 0.15, 0, 0, 0});
        sixToNine.put("Wednesday", new double[]{0.3, 0.55, 0.15, 0, 0, 0});
        sixToNine.put("Thursday", new double[]{0.3, 0.55, 0.15, 0, 0, 0});
        sixToNine.put("Friday", new double[]{0.3, 0.55, 0.15, 0, 0, 0});
        sixToNine.put("Saturday", new double[]{0, 0.2, 0.4, 0.3, 0.1, 0});
        sixToNine.put("Sunday", new double[]{0, 0.2, 0.4, 0.3, 0.1, 0});
        sixToNine.put("NiceSaturday", new double[]{0, 0.2, 0.4, 0.3, 0.1, 0});
        sixToNine.put("NiceSunday", new double[]{0, 0.2, 0.4, 0.3, 0.1, 0});
        this.durationTimeDist.put("6-9", sixToNine);

        Map<String, double[]> tenToEleven = new HashMap<>();
        sixToNine.put("Monday", new double[]{0.3, 0.5, 0.2, 0, 0, 0});
        sixToNine.put("Tuesday", new double[]{0.2, 0.2, 0.1, 0.3, 0.2, 0});
        sixToNine.put("Wednesday", new double[]{0.3, 0.5, 0.2, 0, 0, 0});
        sixToNine.put("Thursday", new double[]{0.3, 0.5, 0.2, 0, 0, 0});
        sixToNine.put("Friday", new double[]{0.3, 0.5, 0.2, 0, 0, 0});
        sixToNine.put("Saturday", new double[]{0, 0.1, 0.1, 0.25, 0.35, 0.2});
        sixToNine.put("Sunday", new double[]{0, 0.1, 0.1, 0.25, 0.35, 0.2});
        sixToNine.put("NiceSaturday", new double[]{0.1, 0.3, 0.1, 0.15, 0.2, 0.15});
        sixToNine.put("NiceSunday", new double[]{0.1, 0.3, 0.1, 0.15, 0.2, 0.15});
        this.durationTimeDist.put("10-11", tenToEleven);

        Map<String, double[]> twelve = new HashMap<>();
        sixToNine.put("Monday", new double[]{0.5, 0.35, 0.13, 0.02, 0, 0});
        sixToNine.put("Tuesday", new double[]{0.5, 0.35, 0.13, 0.02, 0, 0});
        sixToNine.put("Wednesday", new double[]{0.5, 0.35, 0.13, 0.02, 0, 0});
        sixToNine.put("Thursday", new double[]{0.5, 0.35, 0.13, 0.02, 0, 0});
        sixToNine.put("Friday", new double[]{0.45, 0.3, 0.2, 0.05, 0, 0});
        sixToNine.put("Saturday", new double[]{0, 0.05, 0.1, 0.25, 0.35, 0.25});
        sixToNine.put("Sunday", new double[]{0, 0.05, 0.1, 0.25, 0.35, 0.25});
        sixToNine.put("NiceSaturday", new double[]{0.1, 0.3, 0.1, 0.15, 0.2, 0.15});
        sixToNine.put("NiceSunday", new double[]{0.1, 0.3, 0.1, 0.15, 0.2, 0.15});
        this.durationTimeDist.put("12", twelve);

        Map<String, double[]> thirteenToSixteen = new HashMap<>();
        sixToNine.put("Monday", new double[]{0.35, 0.45, 0.2, 0, 0, 0});
        sixToNine.put("Tuesday", new double[]{0.35, 0.45, 0.2, 0, 0, 0});
        sixToNine.put("Wednesday", new double[]{0.35, 0.45, 0.2, 0, 0, 0});
        sixToNine.put("Thursday", new double[]{0.35, 0.45, 0.2, 0, 0, 0});
        sixToNine.put("Friday", new double[]{0.3, 0.4, 0.2, 0.05, 0.05, 0});
        sixToNine.put("Saturday", new double[]{0, 0.02, 0.13, 0.2, 0.4, 0.25});
        sixToNine.put("Sunday", new double[]{0, 0.02, 0.13, 0.2, 0.4, 0.25});
        sixToNine.put("NiceSaturday", new double[]{0, 0.02, 0.13, 0.2, 0.4, 0.25});
        sixToNine.put("NiceSunday", new double[]{0, 0.02, 0.13, 0.2, 0.4, 0.25});
        this.durationTimeDist.put("13-16", thirteenToSixteen);

        Map<String, double[]> seventeenToEighteen = new HashMap<>();
        sixToNine.put("Monday", new double[]{0.4, 0.45, 0.2, 0.15, 0, 0});
        sixToNine.put("Tuesday", new double[]{0.4, 0.45, 0.2, 0.15, 0, 0});
        sixToNine.put("Wednesday", new double[]{0.4, 0.45, 0.2, 0.15, 0, 0});
        sixToNine.put("Thursday", new double[]{0.4, 0.45, 0.2, 0.15, 0, 0});
        sixToNine.put("Friday", new double[]{0.35, 0.45, 0.1, 0.05, 0.05, 0});
        sixToNine.put("Saturday", new double[]{0, 0.02, 0.08, 0.15, 0.45, 0.3});
        sixToNine.put("Sunday", new double[]{0, 0.02, 0.08, 0.15, 0.45, 0.3});
        sixToNine.put("NiceSaturday", new double[]{0.1, 0.3, 0.1, 0.15, 0.2, 0.15});
        sixToNine.put("NiceSunday", new double[]{0.1, 0.3, 0.1, 0.15, 0.2, 0.15});
